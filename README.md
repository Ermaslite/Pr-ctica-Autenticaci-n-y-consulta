...
La aplicación consume los servicios web de SICENET realizando peticiones HTTP, gestionando la cookie de sesión y mostrando la información del perfil del alumno en una pantalla posterior a la autenticación.
